...
<div class="createButtonPopover">
	<form>
		<div>
			<div class="input-append color" data-color="{{=it.foreground}}" data-color-format="hex">
			...
			<div class="input-append color" data-color="{{=it.background}}" data-color-format="hex">
